...
-   **API Tests**: `artifacts/api-server/src/__tests__/` (license validate, sales push idempotency, catalog LWW + cursor, admin auth, purchasing & stock)
