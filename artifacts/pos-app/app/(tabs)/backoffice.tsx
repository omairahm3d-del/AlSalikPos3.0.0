      ...
      <ScrollView contentContainerStyle={s.formContent} showsVerticalScrollIndicator={false}>
        ...
        {Platform.OS === "android" && (
          <TouchableOpacity
            ...
            style={{ backgroundColor: colors.card, borderRadius: colors.radius, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: colors.border, flexDirection: "row", alignItems: "center", gap: 10 }}
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ color: colors.mutedForeground, fontSize: 12, marginTop: 1 }}>
                {printerSettings.usbPrinterEnabled
                  ? printerSettings.usbPrinterName
                    ? `${printerSettings.usbPrinterName} · ${printerSettings.paperWidth ?? "80mm"}`
                    : `VID:${printerSettings.usbPrinterVendorId} · ${printerSettings.paperWidth ?? "80mm"}`
                  : "Tap to configure USB printer"}
              </Text>
            </View>
            {printerSettings.usbPrinterEnabled && (
